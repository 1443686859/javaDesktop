/**
给你一个二维数组 edges 表示一个 n 个点的无向图，其中 edges[i] = [ui, vi, lengthi] 表示节点 ui 和节点 vi 之间有一
条需要 lengthi 单位时间通过的无向边。 
    ...
    public int[] minimumTime(int n, int[][] edges, int[] disappear) {
        ...
        while(!priorityQueue.isEmpty()) {
            ...
            if (temp[0] > ans[temp[1]]) {
                ...
                for (int[] e : g[temp[1]]) {
                    if (e[1] + temp[0] < disappear[e[0]] && (ans[e[0]] < 0 || ans[e[0]] > e[1] + temp[0])) {
