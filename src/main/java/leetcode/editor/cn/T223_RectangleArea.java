...
//Java：矩形面积
public class T223_RectangleArea{
    public static void main(String[] args) {
        Solution solution = new T223_RectangleArea().new Solution();
        // TO TEST
...
class Solution {
    public int computeArea(int ax1, int ay1, int ax2, int ay2, int bx1, int by1, int bx2, int by2) {
        ...
        int common = Math.max(width, 0) * Math.max(length, 0);
        return (ay2 - ay1) * (ax2 - ax1) + (by2 - by1) * (bx2 - bx1) - common;
    }
}
