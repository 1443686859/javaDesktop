...
public class Leetcode5235 {
    ...
    public List<List<Integer>> findWinners(int[][] matches) {
        ...
        for (int[] i : matches) {
            int win = i[0];
            int lose = i[1];
            if (!countMap.containsKey(win)) {
                countMap.put(win, 0);
            }
            countMap.put(lose, countMap.getOrDefault(lose, 0) + 1);
        }
